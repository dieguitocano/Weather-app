...
function App() {
  ...
  console.log(
    `Hoy es ${days[numeroDiaSemana]} + ${hours % 12}:${minutes} ${amPm}`
  );
    ...
    <>
      <div className="App">
        <div className="container1">
          ...
          <p>
            {" "}
            {days[numeroDiaSemana]} {hours % 12}:{minutes} {amPm}
          </p>
        </div>
          ...
          <ul>
            <li>
              <a className="temp" href="">
                {" "}
                {degrees ? tempt?.celcius : tempt?.fahrenheit}
              </a>
            </li>
            <li>
              <a href="">Max {degrees ? tempt?.celMax : tempt?.fahMax}</a>
            </li>
            <li>
              <a href="">Min {degrees ? tempt?.celMin : tempt?.fahMin}</a>
            </li>
            <li>
              <a href="">Humidity {weather?.main?.humidity}</a>
            </li>
            <li>
              <a href="">Wind {weather?.wind?.speed} </a>
            </li>
          </ul>
